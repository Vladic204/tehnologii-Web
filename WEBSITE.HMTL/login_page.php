...
<body>
    <div class="login-container">
        ...
        <form id="loginForm">
            ...
            <div class="button-group">
                <button type="submit" class="nav-button">Logare</button>
                <a href="register_page.php" class="nav-button">Înregistrare</a>
            </div>
        </form>
        <?php if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true): ?>
            <div class="button-group">
                <a href="login_handler.php?logout=true" class="logout-button">Deconectare</a>
            </div>
        <?php endif; ?>
    ...
    $(document).ready(function() {
        $('#loginForm').on('submit', function(e) {
            ...
            // Make AJAX requestlogin
            $.ajax({
                url: 'login.php', // The backend file to handle the login   
                type: 'POST',
                data: formData,
                dataType: 'json',
